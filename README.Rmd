...
Individualised Treatment Effect in high-dimensional linear regression model
...
Finding projection direction in high dimensional binary GLM (logistic regression)
